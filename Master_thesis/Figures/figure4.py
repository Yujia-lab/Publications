...
for ifre in [0,2,3,4]:
    ...
    d = main_dir[ifre]
    # 读取数据
    RT_dir = os.path.join(d,'RT_phase0.mat')
    ...
    d = main_dir[ifre]
    # 读取数据
    RT_dir = os.path.join(d,'RT_phase2.mat')
    RT_file = scio.loadmat(RT_dir)
    RT = RT_file['T2']
    ...
    plt.ylabel('反应时',fontname='SimSun',fontsize=label_size,labelpad=1)
    ...
    os.chdir('E:\HCP\Results_PL\FiguresV0.2\Fig4')
