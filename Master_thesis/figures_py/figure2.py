# -*- coding: utf-8 -*-
"""
Created on Tue Feb 15 16:23:37 2022
...
x_ticks = ['Slow-1','Slow-3','Slow-4','Slow-5']
...
Slow4 = 328*['Slow-4']
Slow5 = 328*['Slow-5']
All_frequency = 4*(Slow1+Slow3+Slow4+Slow5)
...
plt.xlim(-0.7,3.6)
plt.ylim(0.05,0.7)
plt.yticks(np.arange(0.1,0.7,0.1),fontname='Times New Roman',fontsize=tick_size)
plt.xticks(range(4),x_ticks,fontname='Times New Roman',fontsize=tick_size)
plt.tick_params(axis='x',length=0,pad=1)
plt.tick_params(axis='y',length=2,pad=1)



os.chdir('E:\HCP\Results_PL\FiguresV0.2\Fig2')
