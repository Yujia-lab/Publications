...
c_time = 0:dt:10/dt; % Time of kernel (10 seconds) （multiply by 1000 to turn to seconds)
tau_c = 1.25; % Timescale (in ms) （multiply by 1000 to turn to seconds)
d = 2.25; % Delay (in ms) （multiply by 1000 to turn to seconds)
